...
from VoteFlow import normalize_probs
...
class GameFlow:
    ...
    def get_chosen_act_accord_probs(self, legal_moves, pos_acts_with_probs):
        valid_pos_acts_with_probs = {pos_act: pos_acts_with_probs[pos_act] for \
                                     pos_act in pos_acts_with_probs if
                                     Grh.is_move_valid(pos_act,
                                                       legal_moves)}
